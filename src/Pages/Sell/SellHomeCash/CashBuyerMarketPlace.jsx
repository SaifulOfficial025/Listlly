    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mt-8 bg-[#F3F8FF] rounded-lg p-4 shadow-inner">
            <div className="max-w-3xl mx-auto flex items-center bg-white rounded-md p-3 shadow-md">
              <AiOutlineSearch className="text-blue-500 w-5 h-5 mr-3" />
              <input type="text" placeholder="Enter your property address" className="flex-1 focus:outline-none bg-white text-black" />
              <button className="ml-4 bg-gradient-to-b from-[#2B6CB0] to-[#1B4FA0] text-white px-5 py-2 rounded-md shadow-md">Get Cash Offer</button>
            </div>
          </div>
        </div>
      </div>
