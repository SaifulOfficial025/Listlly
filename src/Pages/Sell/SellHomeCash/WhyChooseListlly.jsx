...
function WhyChooseListlly() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6 ml-16">
        {cards.map((c, idx) => (
          <div
            key={idx}
            className="rounded-lg px-14 sm:px-16 p-4 overflow-hidden  w-72 flex flex-col items-center justify-center hover:border border-blue-900"
            style={{
          ...
          >
            <div className="w-36 flex items-center justify-center p-2">
              <img
                src={c.img}
                alt={c.title}
            ...
            <h3 className="text-center text-base sm:text-lg font-semibold text-gray-800 mt-3">
              {c.title}
            </h3>
