  ...
  return (
    <section className="">
      ...
      {/* Property Card */}
        ...
        <img src="/property.jpg" alt="property" className="w-full h-48 sm:h-64 object-cover" />
        <div className="p-4 sm:p-5">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-2 gap-3">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-500">Valley Village, CA 91607</p>
            </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mt-2 mb-2 gap-3">
            ...
            <div className="text-right mt-2 sm:mt-0">
              <span className="block text-xs sm:text-sm text-gray-500">Your home's estimate</span>
              <span className="text-blue-700 font-bold text-lg">$1,752,485</span>
            </div>
          </div>
          <div className="flex flex-wrap gap-4 text-xs sm:text-sm text-gray-500 mb-3">
          ...
          <div className="text-center text-xs sm:text-sm text-gray-500">• Save up to 2.5% in commission • 100% online • More Exposure, more savings</div>
      </div>

      {/* Map Section */}
      <div className="mb-8 px-4 sm:px-10 max-w-6xl mx-auto">
        <h4 className="font-semibold text-lg mb-2 text-black">Location</h4>
        <div className="w-full rounded-lg shadow-md overflow-hidden" style={{height:'220px'}}>
          <iframe
            title="Dummy Map"
