    ...
    <div className="max-w-6xl mx-auto px-6 py-10 text-black">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1 mb-4">
          These Are The Tasks Assigned By Your Settlement Agent. These Are The
          Highest Priority Tasks Necessary To Help You Close Transaction.
        </p>
          ...
          >
            <div>
              <div className="font-medium">
                Complete Seller Info Needed For Settlement File
              </div>
              <div className="text-sm text-gray-500 mt-1">
                Your Settlement Agent Needs Some Important Information To Start
                Your Settlement File. This Tasks Allow Them To Securely Request
                This Information From You. This Information Includes The
                Following
              </div>
            </div>
            ...
            <div className="px-6 py-6 space-y-4 text-sm text-gray-700">
              ...
              <div className="mt-4 flex items-center gap-4">
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/dashboard/selling_properties/start_escrow/settlement_task1"
                    )
                  }
                >
                  Mark As Complete
        ...
        <div className="mt-10">
          ...
          <p className="text-sm text-gray-500 mt-1 mb-4 max-w-2xl">
            20% Of Homes Are Bought By People The Sellers Know! There Is No
            Better Way To Market To These Folks Than Via Social Media
          </p>
        ...
        {/* Under Review Tasks */}
        <div className="mt-10">
          <h3 className="text-lg font-semibold text-[#1C1C1C] mt-8">
            Under Review Tasks
          </h3>
          <div className="mt-4">
            <div className="font-semibold text-base">
              NC Regional MLS-NC Document
            </div>
