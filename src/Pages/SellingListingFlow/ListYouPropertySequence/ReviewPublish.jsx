    ...
    <div className="max-w-6xl mx-auto px-6 py-10 text-black">
      ...
      <div className="bg-white rounded-lg shadow px-6 py-6">
        ...
        <div className="flex items-start gap-6 mb-6">
          ...
          <div className="flex-1">
            <div className="text-sm text-gray-600">
              {property.address || "123 Oak Street, Irvine, CA 92602"}
            </div>
            <div className="text-lg font-semibold">
              {property.title || "Sample Property Title"}
            </div>
            <div className="text-sm text-gray-500 mt-1">
              {property.summary || "4 beds • 3 baths • 2,200 sq ft"}
            </div>
          </div>
          <div className="flex flex-col items-center justify-center text-center drop-shadow-lg">
            <button
              ...
              onClick={() =>
                navigate(
                  "/dashboard/selling_properties/start_escrow/social_media_sharing"
                )
              }
            >
              ➕
        ...
        <div className="space-y-6">
          {/* Accordion sections */}
          <Accordion
            title="California MLS-NC Document"
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <button
            onClick={() =>
              onContinue ? onContinue({ published: true }) : null
            }
        ...
        <div className="text-gray-400">
          {open ? (
            ...
            >
              <path
                fillRule="evenodd"
                d="M5.23 7.21a.75.75 0 011.06.02L10 11.293l3.71-4.062a.75.75 0 111.12 1L10.56 13.06a.75.75 0 01-1.12 0L5.21 8.25a.75.75 0 01.02-1.04z"
                clipRule="evenodd"
              />
            </svg>
          ) : (
            ...
            >
              <path
                fillRule="evenodd"
                d="M14.77 12.79a.75.75 0 01-1.06-.02L10 8.707l-3.71 4.062a.75.75 0 11-1.12-1L9.44 6.94a.75.75 0 011.12 0l4.24 4.82c.27.31.25.78-.03 1.03z"
                clipRule="evenodd"
              />
            </svg>
          )}
