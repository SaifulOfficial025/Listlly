...
function Details() {
  ...
  <Header />
   <div className="max-w-7xl mx-auto px-4 py-6 font-sans text-[#1C1C1C] mt-10">
        ...
        {/* Submitted Offer Card */}
        <div className="mt-10">
          <div className="flex items-center justify-between mb-2">
            <h2 className="text-lg font-semibold text-black">Submitted Offer</h2>
            <button className="text-blue-600 text-sm font-medium">View All</button>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-6 flex flex-col gap-2 shadow">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
              <div className="flex flex-col gap-1">
                <span className="text-blue-600 font-semibold text-lg">John Doe</span>
                <div className="flex gap-6 text-sm text-gray-700 mt-1">
                  <span>Purchase</span>
                  <span>All Cash</span>
                  <a href="#" className="text-blue-600 underline">Buyer Agent Contact</a>
                  <span className="flex items-center gap-1 text-gray-500"><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor"><circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2" fill="none"/><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6v6l4 2" /></svg> Expires In - 1/9/2025</span>
                </div>
              </div>
              <div className="flex flex-col items-end gap-2">
                <div className="flex items-center gap-2">
                  <span className="text-xs text-gray-500 text-right">Counter Offer</span>
                  <span className="text-2xl font-bold text-gray-900">$700,000</span>
                </div>
  ...
  {/* Removed NearbyHomes and NewAddress */}
      </div>
