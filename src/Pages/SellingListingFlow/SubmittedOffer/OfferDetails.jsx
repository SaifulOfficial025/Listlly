      ...
      <table className="w-full table-fixed">
        <tbody className="space-y-3 block">
          ...
          <tr className="border border-gray-200 rounded-sm block">
            <td className="grid grid-cols-3 gap-4 items-center px-4 py-3 ">
              {/* Left link */}
    ...
    <div className="w-full bg-white border border-gray-200 rounded-sm text-black container mx-auto px-4 sm:px-6 lg:px-8 py-6 mb-10">
      ...
      <table className="w-full">
        <tbody className="divide-y divide-gray-200">
          {/* Row 1 */}
          <tr className="grid grid-cols-3 items-center px-4 py-3">
            {/* Left: Icon + Title */}
  ...
  <table className="w-full">
    ...
    <div className="w-full bg-white border border-gray-200 rounded-sm text-black container mx-auto px-4 sm:px-6 lg:px-8 py-6 mb-10">
      ...
      <table className="w-full">
        <tbody className="divide-y divide-gray-200">
          {/* Row: Financing */}
          <tr className="grid grid-cols-3 items-center px-4 py-4">
            {/* Left: Icon + Title */}
            <td className="flex items-center gap-3">
    ...
    <div className="w-full bg-white border border-gray-200 rounded-sm text-black container mx-auto px-4 sm:px-6 lg:px-8 py-6 mb-10">
      ...
      <table className="w-full">
        <tbody className="divide-y divide-gray-200">
          ...
          <tr className="grid grid-cols-3 items-start px-4 py-4">
            {/* Left: Icon + Title */}
