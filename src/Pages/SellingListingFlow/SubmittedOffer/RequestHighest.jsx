...
export default function RequestHighest() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-8 text-black">
      <button onClick={() => navigate(-1)} className="px-4 py-3 border rounded bg-white text-gray-700">Back</button>
      <h1 className="text-2xl font-semibold mb-2">Request Highest &amp; Best Offer</h1>
      ...
      <div className="mt-6">
        ...
        <input type="date" value={deadline} onChange={e=>setDeadline(e.target.value)} className="border rounded px-3 py-2 w-full dark: bg-white" />
      </div>
