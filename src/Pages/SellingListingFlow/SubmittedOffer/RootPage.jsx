  ...
  return (
    <div className="mt-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-semibold text-black">Your Listed Property</h2>
          <p className="text-sm text-gray-500">Property details according to your Info</p>
        </div>

        <div className="flex items-center gap-3">
          <div className="relative">
            <input value={query} onChange={e=>setQuery(e.target.value)} placeholder="Search" className="border rounded px-3 py-2 w-48 text-sm dark:bg-white" />
            <button className="absolute right-1 top-1/2 -translate-y-1/2 px-2 text-gray-500">🔍</button>
          </div>
          <div>
            <button className="px-3 py-2 border rounded text-sm bg-white dark:bg-white text-black">Sort By ▾</button>
          </div>
        </div>
      </div>
