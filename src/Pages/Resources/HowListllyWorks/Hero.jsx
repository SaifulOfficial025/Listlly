...
export default function Hero() {
  return (
    <section className="relative bg-cover bg-center mt-16" style={{ backgroundImage: `url('/ResourcesHero.svg')` }}>

      <div className="relative max-w-6xl mx-auto px-6 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="text-left text-white">
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight">What is <span className="text-[#FF6B6B]">Listlly?</span></h1>
            <p className="mt-4 text-lg text-white/80 max-w-2xl">Listlly is a tech-centric For Sale By Owner website and real estate platform that gives you access to tools only real estate agents have.</p>
