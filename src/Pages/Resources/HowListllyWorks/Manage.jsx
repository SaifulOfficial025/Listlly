    ...
    <div className="space-y-16">
      ...
      <section className="bg-gray-50 py-12">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl font-bold text-gray-900">Manage <span className="text-[#FF6B6B]">Showings</span></h3>
            ...
            <div className="flex flex-col md:flex-row gap-4 items-start">
              ...
              <div className="rounded-lg overflow-hidden shadow md:w-80 flex-shrink-0">
                <VideoEmbed id={demoId} />
      ...
      <section className="py-12">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h3 className="text-2xl font-bold text-gray-900">Managing <span className="text-[#FF6B6B]">Offers</span></h3>
      ...
      <section className="bg-gray-50 py-12">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl font-bold text-gray-900">Settlement <span className="text-[#FF6B6B]">Agent Selection</span></h3>
              <p className="mt-4 text-gray-600 max-w-lg">You can now manage your property showing calendar 100% online. Contact info of buyers and agents who request showings is available for you to reach out.</p>
            </div>
