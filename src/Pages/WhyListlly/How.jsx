    ...
    <section className="py-12 bg-[#FFF5F6]">
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        <div className="mb-8 text-center">
          <h3 className="text-2xl md:text-3xl text-[#EB4E3D] font-semibold">How Listlly's <span className="text-black">Flat Fee MLS Listing Works</span> </h3>
            ...
            <div className="space-y-4">
              {steps.map((s, i) => (
                <div key={i} className="flex items-start gap-4">
                  ...
                  <div className="pt-1 text-[#1C1C1C]">{s}</div>
                </div>
              ))}
            </div>
          </div>
