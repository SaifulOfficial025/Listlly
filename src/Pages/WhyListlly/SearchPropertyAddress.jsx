    ...
    <section className="py-10 bg-[#fffafa]">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
          <div className="flex items-center bg-[#F5F7FB] border border-[#E5E7EB] rounded-lg px-3 py-3 w-full max-w-2xl">
            ...
            <input className="flex-1 bg-transparent outline-none text-left text-sm text-black placeholder-gray-500" placeholder="Enter your property address" />
            <button className="mt-3 sm:mt-0 sm:ml-4 w-full sm:w-auto px-6 py-2 rounded-md bg-gradient-to-r from-[#0054F6] to-[#1A6DFF] text-white font-medium">Get Started</button>
          </div>
        </div>
