          ...
          <div className="absolute bottom-0 left-0 right-0 p-5 z-10">
            ...
            >
              <p className="text-white font-semibold text-[16px] text-center">
                Welcome to{" "}
                <span className="underline text-[#5DA6FF]">Listlly</span>. Your
              ...
              >
                *Discover a simpler, smarter way to buy and sell homes. With
                Listlly, you get access to professional tools, full MLS
                exposure, and personalized support, all while saving on
                commissions.
              </p>
            </div>
          </div>
