...
export default function Hero() {
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-2 md:px-0 py-5 md:py-20 flex flex-col md:flex-row gap-20 md:gap-0 items-center justify-between">
        {/* Left */}
        <div className="flex-1">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-[#1C1C1C] mb-3 leading-tight">
            List Your House on MLS<br />for <span className="text-[#FF6B6B]">$249 only*</span>
          </h1>
          <p className="text-[#5A5A5A] text-lg mb-7 max-w-xl">
        ...
        <div className="flex-1 flex flex-col items-center md:items-start">
          <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-6 mb-4">
            ...
            <div className="flex items-center bg-[#F5F7FB] rounded-lg px-3 py-2 mb-4 border border-[#E5E7EB]">
              ...
              <input type="text" placeholder="Enter your property address" className="flex-1 bg-transparent outline-none text-[#1C1C1C] text-lg" />
            </div>
            <button className="w-full py-3 rounded-lg bg-gradient-to-r from-[#0054F6] to-[#1A6DFF] text-white font-bold text-lg shadow-md mb-3 transition hover:opacity-90">Get Cash Offer</button>
